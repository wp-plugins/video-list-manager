...
function tnt_video_donation(){
	?>
		<div class="wrap">
			<?php screen_icon('options-general') ?>
			<h2>Donation</h2>
			<?php showMessage("If you would like to support further development of this plugin, please consider a <a href='https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=NW7JZN8BEHFVJ' target=_blank >donation!</a>", 1); ?>
			<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="WX7QAHBY7U6E2">
