...
function tnt_video_rate(){
	?>
		<div class="wrap">
			<?php screen_icon('options-general') ?>
			<h2>Donation</h2>
			<?php showMessage("If you would like to support further development of this plugin, please rate me in wordpress!", 1); ?>
			<a href="http://wordpress.org/plugins/video-list-manager/" target=_blank>Click here to rate me </a>
		</div>
	<?php
}//tnt_video_rate
?>